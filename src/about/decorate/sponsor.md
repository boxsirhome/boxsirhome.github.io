...
::: tip 思路
  1. 下载赞赏组件 `Sponsor.vue`，添加到项目组件目录下。组件来自 [Sponsor-Page](https://github.com/OrageKK/sponsor-page) :pray:
...
### 2、创建`Layout.vue`布局，将`Sponsor.vue`组件传入
